 ...
 * @author Chameleon
 */
public class ModifyForm extends javax.swing.JFrame implements Runnable{
   ...
   String getRole;
    ...
    {      
      ...
      public ModifyForm(String username,String role) {
    ...
    private void initComponents() {
        ...
        createchampioship.setText("Modify Champioship");
        ...
        createplayer.setText("Modify Player");
        ...
        createteam.setText("Modify Team");
    ...
    private void createchampioshipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createchampioshipActionPerformed
        ModifyChampionshipList modifyPlayerList = new ModifyChampionshipList(getUsername,getRole);
        modifyPlayerList.setVisible(true);
        this.hide();
